...
public struct PaddedAtomicInt64: ~Copyable, Sendable {
    @usableFromInline internal var _leading = CacheLinePadding()
    private let _value = Atomic<Int64>(0)
    @usableFromInline internal var _trailing = CacheLinePadding()
    ...
    public func add(_ delta: Int64) -> Int64 {
        self._value.wrappingAdd(delta, ordering: .relaxed).oldValue
    }
